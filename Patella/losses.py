...
class BCEFocalLosswithLogits_binggu_nei(nn.Module):
    def __init__(self, gamma=0, alpha=2, reduction='mean'):
        super(BCEFocalLosswithLogits_binggu_nei, self).__init__()
        self.gamma = gamma
        self.alpha = alpha
        self.reduction = reduction
...
class BCEFocalLosswithLogits_binggu_wai(nn.Module):
    def __init__(self, gamma=0, alpha=2.5, reduction='mean'):
        super(BCEFocalLosswithLogits_binggu_wai, self).__init__()
        self.gamma = gamma
        self.alpha = alpha
        self.reduction = reduction
