...
class BCEFocalLosswithLogits_bingguruangu_nei(nn.Module):
    def __init__(self, gamma=0, alpha=0.5, reduction='mean'):
        super(BCEFocalLosswithLogits_bingguruangu_nei, self).__init__()
        self.gamma = gamma
        self.alpha = alpha
        self.reduction = reduction
...
class BCEFocalLosswithLogits_bingguruangu_wai(nn.Module):
    def __init__(self, gamma=0, alpha=1, reduction='mean'):
        super(BCEFocalLosswithLogits_bingguruangu_wai, self).__init__()
        self.gamma = gamma
        self.alpha = alpha
        self.reduction = reduction
