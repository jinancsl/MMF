...
class BCEFocalLosswithLogits_gugu_nei(nn.Module):
    def __init__(self, gamma=0, alpha=1.2, reduction='mean'):
        super(BCEFocalLosswithLogits_gugu_nei, self).__init__()
        self.gamma = gamma
        self.alpha = alpha
        self.reduction = reduction
...
class BCEFocalLosswithLogits_gugu_wai(nn.Module):
    def __init__(self, gamma=0, alpha=2.5, reduction='mean'):
        super(BCEFocalLosswithLogits_gugu_wai, self).__init__()
        self.gamma = gamma
        self.alpha = alpha
        self.reduction = reduction
...
class BCEFocalLosswithLogits_gugu_nei_qian(nn.Module):
    def __init__(self, gamma=0, alpha=4, reduction='mean'):
        super(BCEFocalLosswithLogits_gugu_nei_qian, self).__init__()
        self.gamma = gamma
        self.alpha = alpha
        self.reduction = reduction
...
class BCEFocalLosswithLogits_gugu_nei_zhong(nn.Module):
    def __init__(self, gamma=0, alpha=2, reduction='mean'):
        super(BCEFocalLosswithLogits_gugu_nei_zhong, self).__init__()
        self.gamma = gamma
        self.alpha = alpha
        self.reduction = reduction
...
class BCEFocalLosswithLogits_gugu_nei_hou(nn.Module):
    def __init__(self, gamma=0, alpha=10, reduction='mean'):
        super(BCEFocalLosswithLogits_gugu_nei_hou, self).__init__()
        self.gamma = gamma
        self.alpha = alpha
        self.reduction = reduction
...
class BCEFocalLosswithLogits_gugu_wai_qian(nn.Module):
    def __init__(self, gamma=0, alpha=4, reduction='mean'):
        super(BCEFocalLosswithLogits_gugu_wai_qian, self).__init__()
        self.gamma = gamma
        self.alpha = alpha
        self.reduction = reduction
...
class BCEFocalLosswithLogits_gugu_wai_zhong(nn.Module):
    def __init__(self, gamma=0, alpha=30, reduction='mean'):
        super(BCEFocalLosswithLogits_gugu_wai_zhong, self).__init__()
        self.gamma = gamma
        self.alpha = alpha
        self.reduction = reduction
...
class BCEFocalLosswithLogits_gugu_wai_hou(nn.Module):
    def __init__(self, gamma=0, alpha=10, reduction='mean'):
        super(BCEFocalLosswithLogits_gugu_wai_hou, self).__init__()
        self.gamma = gamma
        self.alpha = alpha
        self.reduction = reduction
